...
func RegisterDStoreServiceServer(s grpc.ServiceRegistrar, srv DStoreServiceServer) {
	s.RegisterService(&DStoreService_ServiceDesc, srv)
}
...
// DStoreService_ServiceDesc is the grpc.ServiceDesc for DStoreService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DStoreService_ServiceDesc = grpc.ServiceDesc{
