...
var file_dstore_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x73, 0x68, 0x32, 0x7c, 0x0a, 0x0d, 0x44, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x65,
	...
	0x2f, 0x62, 0x72, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2f, 0x64, 0x73,
...
var file_dstore_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_dstore_proto_depIdxs = []int32{
	4, // 0: dstore.ReadResponse.value:type_name -> google.protobuf.Any
	4, // 1: dstore.WriteRequest.value:type_name -> google.protobuf.Any
	0, // 2: dstore.DStoreService.Read:input_type -> dstore.ReadRequest
	2, // 3: dstore.DStoreService.Write:input_type -> dstore.WriteRequest
	1, // 4: dstore.DStoreService.Read:output_type -> dstore.ReadResponse
	3, // 5: dstore.DStoreService.Write:output_type -> dstore.WriteResponse
